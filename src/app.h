...
constexpr uint8_t LORA_MESSAGE_HISTORY_SIZE = 6;
constexpr uint8_t LORA_MESSAGE_TEXT_MAX_CHARS = 64;
constexpr uint32_t LORA_MESSAGE_SERVICE_INTERVAL_MS = 20;
constexpr uint32_t LORA_MESSAGE_RENDER_INTERVAL_MS = 500;
constexpr uint32_t LORA_MESSAGE_SEND_COOLDOWN_MS = 10000;
constexpr uint32_t LORA_MESSAGE_ACK_WINDOW_MS = 12000;
constexpr const char* LORA_MESSAGE_DEVICE_ID = "scoober-cardputer";
constexpr const char* LORA_MESSAGE_PEER_ID = "xiao-sx1262-ack";
...
extern unsigned long loraDiagLastPacketMs;
extern uint16_t loraDiagLastPacketLength;
extern uint8_t loraDiagPage;
extern unsigned long lastLoraMessageServiceMs;
extern unsigned long lastLoraMessageRenderMs;
...
extern bool loraMessageInitialized;
extern bool loraMessageRadioReady;
extern bool loraMessageListening;
extern bool loraMessageComposing;
extern bool loraMessageTransmitting;
extern bool loraMessageAwaitingAck;
...
extern String loraMessageStatus;
extern String loraMessageDraft;
...
extern int loraMessageRadioState;
...
extern float loraMessageLastRssi;
extern float loraMessageLastSnr;
...
extern uint32_t loraMessageTxCount;
extern uint32_t loraMessageAckCount;
extern uint32_t loraMessageTimeoutCount;
extern uint32_t loraMessageRxCount;
extern uint32_t loraMessageSequence;
extern LoraMessageEntry loraMessageHistory[LORA_MESSAGE_HISTORY_SIZE];
extern uint8_t loraMessageHistoryCount;
extern uint8_t loraMessageSelectedIndex;
...
void appendLoraMessageCharacter(char key);
