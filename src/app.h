...
constexpr uint32_t LORA_RANGE_SERVICE_INTERVAL_MS = 20;
constexpr uint32_t LORA_RANGE_RENDER_INTERVAL_MS = 500;
constexpr uint32_t LORA_RANGE_SEND_COOLDOWN_MS = 10000;
constexpr uint32_t LORA_RANGE_ACK_WINDOW_MS = 10000;
constexpr uint32_t LORA_RANGE_TX_TIMEOUT_MS = 5000;
constexpr const char* LORA_RANGE_DEVICE_ID = "scoober-cardputer";
constexpr const char* LORA_RANGE_LOG_DIR = "/tracks";
constexpr const char* LORA_RANGE_LOG_HEADER =
    "uptime_s,utc,date,time_source,sequence,result,tx_state,ack_rssi,ack_snr,remote_rssi,remote_snr,battery_pct";
...
extern unsigned long lastLoraRangeServiceMs;
extern unsigned long lastLoraRangeRenderMs;
extern unsigned long loraRangeLastTxMs;
extern unsigned long loraRangeLastAckMs;
...
extern bool loraRangeInitialized;
extern bool loraRangeRadioReady;
extern bool loraRangeListening;
extern bool loraRangeArmed;
extern bool loraRangeTransmitting;
extern bool loraRangeAwaitingAck;
...
extern String loraRangeStatus;
extern String loraRangeLogStatus;
extern String loraRangeLogFileName;
...
extern int loraRangeRadioState;
...
extern float loraRangeLastAckRssi;
extern float loraRangeLastAckSnr;
...
extern uint32_t loraRangeTxCount;
extern uint32_t loraRangeTxFailCount;
extern uint32_t loraRangeAckCount;
extern uint32_t loraRangeAckTimeoutCount;
extern uint32_t loraRangeLogRowCount;
extern uint32_t loraRangeSequence;
